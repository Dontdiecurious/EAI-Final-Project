...
// (3) Jika sudah coba deh kalian ambil data dari form (CLUE : pakai POST)
    ...
    $query = mysqli_query($connect, "INSERT INTO showroom_mobil(harga_mobil, brand_mobil, warna_mobil, tipe_mobil, harga_mobil)
                                    VALUES('$harga_mobil','$brand_mobil','$warna_mobil', '$tipe_mobil', '$harga_mobil')");
    
    // (5) Buatkan kondisi jika eksekusi query berhasil
    if ($query) {
        echo "<script>alert('Data telah berhasil diinput')</script>";
        echo "<meta-http-equiv='refresh content='1 ur1=list_mobil.php'>";
    }
    // (6) Jika terdapat kesalahan, buatkan eksekusi query gagalnya 
    else {
        echo "<script>alert('Data ditambahkan)</script>";
        echo "<meta-http-equiv='refresh content='1 ur1=form_create_mobil.php'>";
    }
